...
## **Integrantes del grupo:** Sofia Holod y Ane Segurola
## **Enlace al repositorio:** https://github.com/sholod96/Tipolog-a_PR2
## **Enlace al vídeo en Google Drive: https://drive.google.com/file/d/1sQEe6iZY4b06LrProAtFNK1wghR0b0kM/view?ts=659dbfb1**
"""
...
Para esta práctica hemos elegido el dataset Australia Weather Data, que consiste en una colección de observaciones recogidas a lo largo de 10 años en diferentes estaciones metereológicas de Australia. El dataset contiene información sobre varias condiciones metereológicas recogidas en un día concreto. Los datos de las observaciones metereológicas proceden de la página del departamento de metereología del gobierno de Australia y se pueden consultar en los siguientes enlaces:
